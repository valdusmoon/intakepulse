    ...
    <MarketingShell>
      ...
      <section className="px-6 py-14 bg-white border-y border-[#e3e7ed]">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-cv-heading text-2xl font-bold mb-6">Why {industry.name.toLowerCase().includes("contracting") ? "contractors" : `${industry.name.toLowerCase()} companies`} lose these calls</h2>
      ...
      <section className="px-6 py-14 bg-white border-y border-[#e3e7ed]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-6 text-sm text-[#98a2b3]">Typical job value on these leads: <span className="font-semibold text-[#667085]">{industry.valueRange}</span>.</p>
        </div>
      </section>

      {/* FAQ */}
      <section className="px-6 py-16 max-w-3xl mx-auto">
        <h2 className="font-cv-heading text-2xl font-bold mb-6 text-center">{industry.name} questions, answered</h2>
      ...
      <section className="px-6 py-16 bg-landing-ink text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-cv-heading text-2xl sm:text-3xl font-bold mb-3">Stop losing {industry.name} calls to voicemail.</h2>
          <p className="text-white/55 mb-7 max-w-xl mx-auto">Give your team the first ring. Let Callverted catch the rest and turn them into ranked leads.</p>
