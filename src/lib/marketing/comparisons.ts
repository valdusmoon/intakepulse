...
export const COMPARISONS: Comparison[] = [
  {
    ...
    rows: [
      { dimension: "Answers the call", them: "No — the caller talks to a machine", us: "Yes — answers live and runs a real intake" },
  ...
  },
  {
    ...
    rows: [
      { dimension: "Who does the work", them: "The caller — they must read and reply to a text", us: "Callverted — it answers and asks the questions" },
    ...
    faqs: [
      { q: "Can I use both?", a: "You can, but for urgent trades Callverted covers the same gap more completely — it doesn't depend on the caller replying." },
