...
/**
 * V8LeakCalculator — the three-input "The Math" calculator for /v8. Sizes the
 * opportunity, it does NOT assume every lead books:
 ...
 * Conservative defaults. Renders white-on-dark to sit inside the dark ROI card.
 */
...
export function V8LeakCalculator() {
