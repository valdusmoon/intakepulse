...
/**
 * V7Media — page-scoped fork of the shared MediaSlot helpers /v7 uses:
 *   - V7BrowserFrame: browser-chrome wrapper for the dashboard screenshot.
 *   - V7AudioSlot: a press-play audio player placeholder (no real recording yet).
 * Self-contained so /v7 can iterate on either without touching the shared file.
 */
...
/**
 * Browser-chrome wrapper. Wrap a screenshot in this to make a dashboard read as
 * software instead of as a floating rectangle.
 */
export function V7BrowserFrame({
  children,
