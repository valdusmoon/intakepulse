...
/**
 * V7HeroScenes — the animated hero for /v7 (page-scoped fork of the live
 * homepage's HeroScenes). Self-contained: its own scene context, backdrop, and
 * floating dark-glass panel, so /v7's hero can be iterated without touching /,
 * /v5, or /v6.
 *
 ...
 *
 * All motion is CSS + a small JS timeline. ?scene=0|1|2 freezes a scene for
 * screenshots/QA. Respects prefers-reduced-motion (pins to the payoff, the lead
 * packet). Illustrative scripted content — no real customer data.
 */
...
export function V7HeroScenesProvider({ children, tone = "dark" }: { children: ReactNode; tone?: Tone }) {
...
export function V7HeroBackdrop() {
...
export function V7HeroSceneCard() {
