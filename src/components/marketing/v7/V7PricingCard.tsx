...
/**
 * V7PricingCard — page-scoped fork of the shared PricingCard. One product, two
 * cadences (monthly $149 / annual $1,499), 14-day trial. Keeps importing the
 * shared @/lib/pricing constants (low-level source-of-truth data, not iteration
 * surface). Both CTAs go to /sign-up; the plan is chosen in-app at "go live".
 */
export function V7PricingCard() {
