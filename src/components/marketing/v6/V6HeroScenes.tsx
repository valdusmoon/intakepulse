...
/**
 * V6HeroScenes — page-scoped fork of the shared HeroScenes for /v6.
 *
 * Self-contained copy so /v6's split-hero demo can be iterated without touching
 * /, /v5, or /v7. The animated hero walks one call through the product story:
 *
 ...
 *
 * All motion is CSS + a small JS timeline. Built as a provider so the backdrop and
 * panel share one scene index. ?scene=0|1|2 freezes a scene (screenshots/QA).
 * Respects prefers-reduced-motion. Illustrative scripted content — no real data.
 */
