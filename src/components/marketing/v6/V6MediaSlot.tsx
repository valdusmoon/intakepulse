...
/**
 * V6MediaSlot — page-scoped fork of the shared MediaSlot for /v6.
 *
 * Only the two frames /v6 actually uses are carried over: <AudioSlot/> (the
 * press-play sample-intake placeholder for the "Hear It" band, no real audio
 * loaded yet) and <BrowserFrame/> (the browser-chrome wrapper around the real
 * dashboard screenshot in "See It Work"). Forked so /v6 can iterate these
 * without affecting /, /v5, or /v7.
 */
 ...
 * control in place. The waveform is static; the play button toggles a fake
...
export function AudioSlot({
  ...
  return (
    <div
      ...
      style={{
        borderColor: dark ? "rgba(255,255,255,0.22)" : AUDIO.br,
        background: dark ? "rgba(255,255,255,0.045)" : AUDIO.bg,
      }}
    >
...
/**
 * Browser-chrome wrapper drawn in markup. Wrap a screenshot in this to make a
