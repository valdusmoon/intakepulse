...
/**
 * Landing pricing card with a Monthly | Annual billing toggle. One product, two
 * cadences — no feature tiers, so the feature list is identical and only the
 * price/framing swaps. Annual leads with the effective monthly ($125) as the
 * hero number, with the annual total + savings disclosed right under it. Both
 * CTAs go to /sign-up; the actual plan is chosen in-app at "go live".
 */
