...
/**
 * Page-scoped pricing card for /v5 — forked from PricingCard.tsx so /v5 can be
 * iterated independently. Monthly | Annual billing toggle over one product (no
 * feature tiers). The shared price/feature constants stay imported from
 * `@/lib/pricing` (a low-level data module, kept shared on purpose).
 */
export function V5PricingCard() {
