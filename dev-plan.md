...
- [ ] **Two zombie test leads from the pre-fix broken calls** (Bob 0c673bfb, "Dane" fbecfb9c — unscored, stuck 'new', polluting the badge count). Decide: re-fire finalize or delete from prod demo business. NOTE: with the badge now counting new+qualified they still pollute it — resolve before judging the badge fix on the next call.
